...
function QuestionSummary(props){
    ...
    return(
        <div className="question-container">
            ...
            {props.question.description && <div className="question-description" dangerouslySetInnerHTML={{__html: convertToHTML(convertFromRaw(JSON.parse(props.question.description)))}}></div> }
            ...
            <div className="display-flex">
                ...
                {props.question.user && <a className="user-link" href={'/users/' + props.question.user._id}>{props.question.user.nickname ? props.question.user.nickname : props.question.user.name + ' ' + props.question.user.surname}</a> }
            </div>
        </div>
    )
}
